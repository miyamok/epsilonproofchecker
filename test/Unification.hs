...
test = do
    -- putStrLn $ show $ isUnifiablePair [Left (Var "y" (-1))] [Left(Var "x" (-1))] [] (Left ((pt "x"),(pt "y")))
    -- putStrLn $ show $ isUnifiablePair [] [Left(Var "x" (-1))] [] (Left ((pt "x"),(pt "f (c)")))
    ...
    -- putStrLn $ show $ isUnifiablePair [Right(Pvar "P" (-1) 1)] [Left (Var "x" (-1))] [] (Right (pf "P(x)", pf "P(c)"))
    -- putStrLn $ show $ isUnifiablePair [Right(Pvar "P" (-1) 1)] [Right(Pvar "A" (-1) 0), Left(Var "x" (-1))] [] (Right (pf "A", pf "P(x)"))
